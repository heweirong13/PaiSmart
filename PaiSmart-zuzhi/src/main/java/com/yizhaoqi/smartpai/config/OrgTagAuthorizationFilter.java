    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (path.matches(".*/upload/chunk.*") || 
                ...
                (path.matches(".*/documents/[a-fA-F0-9]{32}.*") && "PUT".equals(request.getMethod()))) {
                ...
                if (path.contains("/chunk")) {
                    ...
                    operation = "删除文档";
                } else if ("PUT".equals(request.getMethod()) && path.matches(".*/documents/[a-fA-F0-9]{32}.*")) {
                    operation = "编辑文档";
                }
                ...
                if (token != null) {
                    ...
                    if (userId != null) {
                        ...
                        request.setAttribute("orgTags", orgTags != null ? orgTags : "");
