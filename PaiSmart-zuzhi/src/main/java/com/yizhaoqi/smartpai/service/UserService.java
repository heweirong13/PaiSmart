...
public class UserService {
    ...
    public void registerUser(String username, String password) {
        ...
        logger.info("User registered successfully with private and default organization tags: {}", username);
    }
    ...
    public void createAdminUser(String username, String password, String creatorUsername) {
        ...
        // 创建用户的私人组织标签
        String privateTagId = PRIVATE_TAG_PREFIX + username;
        createPrivateOrgTag(privateTagId, username, adminUser);

        // 分配私人组织标签和默认组织标签
        adminUser.setOrgTags(privateTagId + "," + DEFAULT_ORG_TAG);

        // 设置私人组织标签为主组织标签
        adminUser.setPrimaryOrg(privateTagId);
        ...
        logger.info("Admin user created successfully with organization tags: {}", username);
    }
    ...
    public void deleteUser(Long userId, String adminUsername) {
        ...
        if (admin.getRole() != User.Role.ADMIN) {
            throw new CustomException("Only administrators can delete users", HttpStatus.FORBIDDEN);
        }
        ...
        if (user.getUsername().equals(adminUsername)) {
            throw new CustomException("Cannot delete yourself", HttpStatus.BAD_REQUEST);
        }
        ...
        // 删除用户的私人组织标签
        String privateTagId = PRIVATE_TAG_PREFIX + username;
        organizationTagRepository.findByTagId(privateTagId).ifPresent(organizationTagRepository::delete);
